...
function TableHead({ className, ...props }: ColumnProps) {
  return (
    <ColumnPrimitive
      ...
      className={cn(
        "h-10 px-4 first:pl-6 last:pr-6 text-left align-middle font-medium whitespace-nowrap text-foreground [&:has([data-slot=checkbox])]:pr-0 [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: CellProps) {
  return (
    <CellPrimitive
      ...
      className={cn(
        "py-2 px-4 first:pl-6 last:pr-6 align-middle whitespace-nowrap [&:has([data-slot=checkbox])]:pr-0 [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
