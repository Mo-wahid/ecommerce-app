...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <h1 className="text-3xl font-bold text-gray-900 border-b pb-4">Checkout</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm h-fit">
          ...
          <div className="border-t border-gray-200 pt-4 mb-2 flex justify-between text-gray-600">
            <span>Subtotal</span>
