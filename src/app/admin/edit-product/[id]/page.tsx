...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const onSubmit = async (data: ProductFormOutput) => {
    ...
    try {
      ...
      if (!productRes.ok) throw new Error(productJson.message || "Failed to update product");
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <div className="mb-6">
        <Link href="/admin/products" className="text-brand-600 hover:underline text-sm font-medium">
            ...
            <div className="md:col-span-2">
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 dark:border-slate-600 border-dashed rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                <div className="space-y-1 text-center">
                  ...
                  <p className="text-xs text-slate-500">Leave blank to keep existing image</p>
                  {imageFile && (
