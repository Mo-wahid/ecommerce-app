  ...
  return (
    <div className="flex justify-center items-center min-h-[70vh] py-12">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none w-full max-w-md border border-slate-100 dark:border-slate-700 transition-colors">
        <h2 className="text-3xl font-black text-center text-slate-900 dark:text-slate-100 mb-8 tracking-tight">Create an Account</h2>
        ...
        <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link href="/login" className="text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 font-semibold hover:underline">
            Log in here
          </Link>
        </p>
      </div>
